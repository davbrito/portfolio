              ...
              {profileFields.map((configuredField) => {
                ...
                return (
                  <form.AppField
                    ...
                    validators={getAuthAdditionalFieldValidators(configuredField, localization.auth.fieldRequired)}
                  >
                    {(field) => <field.AuthFormAdditionalField field={configuredField} isPending={isPending} />}
                  </form.AppField>
                );
              })}
            </CardContent>
