 ...
 */
export function SignUp({ className, socialLayout, socialPosition = "bottom", onSignUpSuccess }: SignUpProps) {
  const {
    additionalFields,
    authClient,
    basePaths,
  ...
  const signUpFields = useMemo(() => additionalFields?.filter((field) => field.signUp) ?? [], [additionalFields]);
