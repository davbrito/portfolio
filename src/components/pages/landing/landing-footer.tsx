...
export default function LandingFooter({ socialLinks, name }: Props) {
  return (
    <footer
      role="contentinfo"
      className="text-muted-foreground mt-16 flex flex-col items-center gap-2 pb-6 text-center text-xs"
    >
      ...
      <p>
        Diseñado y desarrollado por <span className="text-primary">{name}</span>. Hecho con Tanstack Start, React y
        Tailwind CSS.
      </p>
